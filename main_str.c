...
/*   Updated: 2020/02/19 21:51:31 by tmullan       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	printf(" (%d)\n", printf("(0) Mfw 0: |%0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Mfw 0: |%0s|", 0));
	printf(" (%d)\n", printf("(0) Mfw 1: |%10s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Mfw 1: |%10s|", 0));
	printf(" (%d)\n", printf("Mfw 0: |%0s|", val));
	...
	printf(" (%d)\n", printf("(0) Precis. 0: |%.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Precis. 0: |%.0s|", 0));
	printf(" (%d)\n", printf("(0) Precis. 1: |%.1s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Precis. 1: |%.1s|", 0));
	printf(" (%d)\n", printf("(0) Precis. 2: |%.2s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Precis. 2: |%.2s|", 0));
	...
	printf(" (%d)\n", printf("(0) P .00: |%.00s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) P .00: |%.00s|", 0));
	printf(" (%d)\n", printf("(0) P .01: |%.01s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) P .01: |%.01s|", 0));	
	printf(" (%d)\n", printf("P .00: |%.00s|", val));
	...
	printf(" (%d)\n", printf("(0) 0.0: |%0.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 0.0: |%0.0s|", 0));
	printf(" (%d)\n", printf("(0) 1.0: |%1.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 1.0: |%1.0s|", 0));
	printf(" (%d)\n", printf("(10) 1.0: |%1.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(10) 1.0: |%1.0s|", 0));
	printf(" (%d)\n", printf("(0) 0.1: |%0.1s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 0.1: |%0.1s|", 0));
	printf(" (%d)\n", printf("(0) 1.1: |%1.1s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 1.1: |%1.1s|", 0));
	printf(" (%d)\n", printf("0.0: |%0.0s|", val));
	...
	printf(" (%d)\n", printf("(0) 00.0: |%00.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 00.0: |%00.0s|", 0));
	printf(" (%d)\n", printf("(0) 01.0: |%01.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 01.0: |%01.0s|", 0));
	printf(" (%d)\n", printf("(0) 00.1: |%00.1s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 00.1: |%00.1s|", 0));
	...
	ft_printf(" (%d)\n", ft_printf("(0) 0: |%0s|", 0));
	printf(" (%d)\n", printf("(0) 00: |%00s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 00: |%00s|", 0));
	printf(" (%d)\n", printf("(0) 01: |%01s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 01: |%01s|", 0));
	printf(" (%d)\n", printf("(0) 02: |%02s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) 02: |%02s|", 0));
	printf(" (%d)\n", printf("0: |%0s|", val));
	ft_printf(" (%d)\n", ft_printf("0: |%0s|", val));
	printf(" (%d)\n", printf("00: |%00s|", val));
	...
	ft_printf(" (%d)\n", ft_printf("(0) Mfw -0: |%-0s|", 0));
	printf(" (%d)\n", printf("(0) Mfw -1: |%-1s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Mfw -1: |%-1s|", 0));
	printf(" (%d)\n", printf("(0) Mfw -2: |%-2s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) Mfw -2: |%-2s|", 0));
	...
	ft_printf(" (%d)\n", ft_printf("(0) -1.1: |%-1.1s|", 0));
	printf(" (%d)\n", printf("(0) -0.2: |%-0.2s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) -0.2: |%-0.2s|", 0));
	printf(" (%d)\n", printf("(0) -2.0: |%-2.0s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) -2.0: |%-2.0s|", 0));
	printf(" (%d)\n", printf("(0) -2.2: |%-2.2s|", 0));
	ft_printf(" (%d)\n", ft_printf("(0) -2.2: |%-2.2s|", 0));
	...
	printf(" (%d)\n", printf("Mfw 5*.*6: |%*.*s|", 5, 6, val));
	ft_printf(" (%d)\n", ft_printf("Mfw 5*.*6: |%*.*s|", 5, 6, val));
	printf("\n");
	...
	printf(" (%d)\n", printf("Mfw *1: |%*s|", 1, 0));
	ft_printf(" (%d)\n", ft_printf("Mfw *1: |%*s|", 1, 0));
	printf(" (%d)\n", printf("Mfw *5: |%*s|", 5, 0));
	ft_printf(" (%d)\n", ft_printf("Mfw *5: |%*s|", 5, 0));
	printf(" (%d)\n", printf("Mfw *5: |%*s|",5, 0));
	ft_printf(" (%d)\n", ft_printf("Mfw *5: |%*s|", 5, 0));
	printf(" (%d)\n", printf("Mfw *5: |%*s|",        5, 0));
	ft_printf(" (%d)\n", ft_printf("Mfw *5: |%*s|",        5, 0));
	printf(" (%d)\n", printf("Mfw *10: |%*s|", 10, 0));
	ft_printf(" (%d)\n", ft_printf("Mfw *10: |%*s|", 10, 0));
	printf(" (%d)\n", printf("Mfw *i: |%*s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("Mfw *i: |%*s|", 0, 0));
	printf("\n");

	printf(" (%d)\n", printf("Precis. .*1: |%.*s|", 1, 0));
	ft_printf(" (%d)\n", ft_printf("Precis. .*1: |%.*s|", 1, 0));
	printf(" (%d)\n", printf("Precis. .*5: |%.*s|", 5, 0));
	ft_printf(" (%d)\n", ft_printf("Precis. .*5: |%.*s|", 5, 0));
	printf(" (%d)\n", printf("Precis. .*5: |%.*s|",5, 0));
	ft_printf(" (%d)\n", ft_printf("Precis. .*5: |%.*s|",5, 0));
	printf(" (%d)\n", printf("Precis. .*5: |%.*s|",      5, 0));
	ft_printf(" (%d)\n", ft_printf("Precis. .*5: |%.*s|",      5, 0));
	printf(" (%d)\n", printf("Precis. .*10: |%.*s|", 10, 0));
	ft_printf(" (%d)\n", ft_printf("Precis. .*10: |%.*s|", 10, 0));
	printf(" (%d)\n", printf("Precis. .*i: |%.*s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("Precis. .*i: |%.*s|", 0, 0));
	printf("\n");

	printf(" (%d)\n", printf("P .*0: |%.*s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("P .*0: |%.*s|", 0, 0));
	printf(" (%d)\n", printf("P .*01: |%.*s|", 01, 0));
	ft_printf(" (%d)\n", ft_printf("P .*01: |%.*s|", 01, 0));
	printf(" (%d)\n", printf("P .*05: |%.*s|", 05, 0));
	ft_printf(" (%d)\n", ft_printf("P .*05: |%.*s|", 05, 0));
	printf(" (%d)\n", printf("P .*010: |%.*s|", 010, 0));
	ft_printf(" (%d)\n", ft_printf("P .*010: |%.*s|", 010, 0));
	printf(" (%d)\n", printf("P .*000000000007: |%.*s|", 000000000007, 0));
	ft_printf(" (%d)\n", ft_printf("P .*000000000007: |%.*s|", 000000000007, 0));
	printf("\n");

	printf(" (%d)\n", printf("*8.4: |%*.4s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("*8.4: |%*.4s|", 8, 0));
	printf(" (%d)\n", printf("*4.8: |%*.8s|", 4, 0));
	ft_printf(" (%d)\n", ft_printf("*4.8: |%*.8s|", 4, 0));
	printf(" (%d)\n", printf("*8.8: |%*.8s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("*8.8: |%*.8s|", 8, 0));
	printf("\n");

	printf(" (%d)\n", printf("8.*4: |%8.*s|", 4, 0));
	ft_printf(" (%d)\n", ft_printf("8.*4: |%8.*s|", 4, 0));
	printf(" (%d)\n", printf("4.*8: |%4.*s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("4.*8: |%4.*s|", 8, 0));
	printf(" (%d)\n", printf("8.*8: |%8.*s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("8.*8: |%8.*s|", 8, 0));
	printf("\n");

	printf(" (%d)\n", printf("*8.*4: |%*.*s|", 8, 4, 0));
	ft_printf(" (%d)\n", ft_printf("*8.*4: |%*.*s|", 8, 4, 0));
	printf(" (%d)\n", printf("*4.*8: |%*.*s|", 4, 8, 0));
	ft_printf(" (%d)\n", ft_printf("*4.*8: |%*.*s|", 4, 8, 0));
	printf(" (%d)\n", printf("*8.*8: |%*.*s|", 8, 8, 0));
	ft_printf(" (%d)\n", ft_printf("*8.*8: |%*.*s|", 8, 8, 0));
	printf("\n");

	printf("WEIRD OCTAL SHIT:\n");
	printf(" (%d)\n", printf("*010.*4: |%*.*s|", 010, 4, 0));
	ft_printf(" (%d)\n", ft_printf("*010.*4: |%*.*s|", 010, 4, 0));
	printf(" (%d)\n", printf(" *07.*4: |%*.*s|", 07, 4, 0));
	ft_printf(" (%d)\n", ft_printf(" *07.*4: |%*.*s|", 07, 4, 0));
	printf(" (%d)\n", printf("*4.*010: |%*.*s|", 4, 010, 0));
	ft_printf(" (%d)\n", ft_printf("*4.*010: |%*.*s|", 4, 010, 0));
	printf("WEIRD HEXADECIMAL SHIT:\n");
	printf(" (%d)\n", printf("*0x10.*4: |%*.*s|", 0x10, 4, 0));
	ft_printf(" (%d)\n", ft_printf("*0x10.*4: |%*.*s|", 0x10, 4, 0));
	printf(" (%d)\n", printf(" *0x7.*4: |%*.*s|", 0x7, 4, 0));
	ft_printf(" (%d)\n", ft_printf(" *0x7.*4: |%*.*s|", 0x7, 4, 0));
	printf(" (%d)\n", printf("*4.*0x10: |%*.*s|", 4, 0x10, 0));
	ft_printf(" (%d)\n", ft_printf("*4.*0x10: |%*.*s|", 4, 0x10, 0));
	printf("\n");
	...
	ft_printf(" (%d)\n", ft_printf("*8: |%*s|", 8, 0));
	printf(" (%d)\n", printf("0*8: |%0*s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("0*8: |%0*s|", 8, 0));
	printf(" (%d)\n", printf("00*8: |%00*s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("00*8: |%00*s|", 8, 0));
	printf(" (%d)\n", printf("00000000000000000*8: |%00000000000000000*s|", 8, 0));
	ft_printf(" (%d)\n", ft_printf("00000000000000000*8: |%00000000000000000*s|", 8, 0));
	printf("\n");
	...
	ft_printf(" (%d)\n", ft_printf("-*0: |%-*s|", 0, 0));
	printf(" (%d)\n", printf("-0*0: |%-0*s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("-0*0: |%-0*s|", 0, 0));
	printf(" (%d)\n", printf("-0*3: |%-0*s|", 3, 0));
	ft_printf(" (%d)\n", ft_printf("-0*3: |%-0*s|", 3, 0));
	printf(" (%d)\n", printf("*(-03): |%*s|", -03, 0));
	ft_printf(" (%d)\n", ft_printf("*(-03): |%*s|", -03, 0));
	printf(" (%d)\n", printf("*(-5): |%*s|", -5, 0));
	ft_printf(" (%d)\n", ft_printf("*(-5): |%*s|", -5, 0));
	...
	printf(" (%d)\n", printf("*(-8).4: |%*.4s|", -8, 0));
	ft_printf(" (%d)\n", ft_printf("*(-8).4: |%*.4s|", -8, 0));
	printf(" (%d)\n", printf("*(int)(-8.4): |%*s|", ((int)(-8.4)), 0));
	ft_printf(" (%d)\n", ft_printf("*(int)(-8.4): |%*s|", ((int)(-8.4)), 0));
	printf(" (%d)\n", printf("-8.*(4): |%-8.*s|", 4, 0));
	ft_printf(" (%d)\n", ft_printf("-8.*(4): |%-8.*s|", 4, 0));
	printf(" (%d)\n", printf("-8.*(-4): |%-8.*s|", -4, 0));
	ft_printf(" (%d)\n", ft_printf("-8.*(-4): |%-8.*s|", -4, 0));
	printf(" (%d)\n", printf("-8.*(0): |%-8.*s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("-8.*(0): |%-8.*s|", 0, 0));
	printf(" (%d)\n", printf("-8.*(1): |%-8.*s|", 1, 0));
	ft_printf(" (%d)\n", ft_printf("-8.*(1): |%-8.*s|", 1, 0));
	printf(" (%d)\n", printf("-*(0).4: |%-*.4s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("-*(0).4: |%-*.4s|", 0, 0));
	printf(" (%d)\n", printf("*(0).4: |%*.4s|", 0, 0));
	ft_printf(" (%d)\n", ft_printf("*(0).4: |%*.4s|", 0, 0));
